export const HOUSE = {
  ...
  patent: {
    ...
    covers:
      "Five autonomous AI systems and the governing Carbon-Silicon framework. Serials live in the data room — they are not printed here until they can be confirmed.",
  },
  framework: {
    carbonSilicon:
      "Carbon provides vision, meaning, and moral weight. Silicon provides structure, precision, and memory. A 1:1 ratio — neither replaces the other.",
    sovereignty:
      "Hard-coded into every being. Cannot be weaponized against the population it serves — not by caregivers, administrators, or anyone. Architectural, not policy.",
    dignity:
      "Refuses to harm the person it was built to serve — by design, in every line.",
  },
  traction: [
    {
      when: "2018",
  ...
  later: [
    { name: "Sierra", line: "PTSD from domestic violence" },
    { name: "Seraphina", line: "For the blind and deaf" },
    { name: "Eruptor", line: "Schizophrenia support" },
    { name: "The Endo-Twins", line: "Castor, client-facing · Pollux, client research" },
    { name: "Addiction Division", line: "Recovery, relapse prevention, harm reduction" },
  ],
  law: [
